...
<!--fonts-->
<script
src="https://kit.fontawesome.com/3bfe27db48.js"
  ...
  <div class="header">
    ...
    <div  class="header-top">
      <div class="header-bottom">
        ...
        <ul class="nav">
          <li style="left: -25px;"><i style="font-size: 22px;"class="fab fa-joomla"></i></li>
...
<!-- end content_slider -->
<a href="cart.php" >
<div style="position: fixed; right: 20px; bottom: 20px; background: rgb(123, 169, 255); width: 60px; height: 60px; border-radius: 7px; display: flex; justify-content: center; align-items: center; z-index: 2000;">
   <i class="fas fa-shopping-cart" style="font-size: 24px; color: #fff;"></i>

   <div style="position: absolute; top: -10px; right: -10px; background: rgb(255, 93, 93); width: 25px; height: 25px ; color: #fff; display: flex; justify-content: center; align-items: center; border-radius: 100%;"><?php Total_Cart();?>  </div>
</div>
</a>
